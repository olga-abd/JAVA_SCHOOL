public class Task4 {
    public static void main (String[] args){
        ...
        System.out.println("Калькулятор, рассчитывающий корень:");
        CalcSqrt calcSqrt = new CalcSqrt();
        calcSqrt.calculate("3 + корень(9) + 7"); // 13
        calcSqrt.printResult();

        System.out.println("Калькулятор, учитывающий отрицательные значения:");
        CalcNegative calcNegative = new CalcNegative();
        calcNegative.calculate("3 + -7 - 1 - -8"); // 3
        calcNegative.printResult();
    }
}
